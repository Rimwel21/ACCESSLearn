...
def update_student_profile(request: Request,update: StudentProfileUpdate, db: Session, current_user: Accounts):
    ...
    selected_section_id = update_profile.get(
        section_id,
    ...
    if grade_level_id in update_profile or section_id in update_profile:
        get_section_for_grade_or_400(selected_section_id, selected_grade_level_id, db)
